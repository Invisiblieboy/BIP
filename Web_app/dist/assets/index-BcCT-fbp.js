...
`,Y=`
    ...
    </div>`;let p="info";const R={info:"info",wallet:"account_balance_wallet",cart:"shopping_cart",book:"import_contacts"};let f=Object.keys(R);function F(){let e=f.indexOf(p)+1;e<f.length&&h(f[e])}function j(){let e=f.indexOf(p)-1;e>=0&&h(f[e])}function h(e){let t=document.getElementById("btn-".concat(p));t==null||t.classList.remove("gold"),t==null||t.classList.add("gold-dark"),p=e,V();let n=document.getElementById("btn-".concat(e));n==null||n.classList.remove("gold-dark"),n==null||n.classList.add("gold")}function Q(){const e=document.getElementById("bottom-navigation");f.forEach(t=>{let n="btn-".concat(t);e.insertAdjacentHTML("beforeend",`
            <div id="${n}" class="nav-img gold-dark" style="width: ${100/f.length}%">
                    <span class="material-symbols-outlined" >${R[t]}</span>

            </div>`),document.querySelector("#"+n).addEventListener("click",()=>{h(t)})}),h(p)}let w=window.Telegram.WebApp;function Z(){w.isVerticalSwipesEnabled=!1,w.ready(),w.expand(),w.disableVerticalSwipes()}function ee(){return w.initData.trim()===""&&!_.tg_mode?(h("error_tg"),1):0}const c=new TON_CONNECT_UI.TonConnectUI({manifestUrl:"https://static.biptoken.xyz/MANIFEST.json",buttonRootId:"ton-connect",enableAndroidBackHandler:!0});c.uiOptions={twaReturnUrl:"https://t.me/BIPapp_bot",language:"ru",uiPreferences:{theme:"SYSTEM"}};c.onStatusChange(e=>{if(c.connected){const t=c.account.address;localStorage.setItem("wallet_address",t),_.tg_mode||axios.post(`https://api.biptoken.xyz/v1/auth/nuw?wallet_address=${t}&tgInitData=${encodeURIComponent(w.initData)}`)}else localStorage.setItem("wallet_address","");localStorage.setItem("wallet_connect",c.connected),E(),W()});async function te(){try{await c.openModal()}catch{console.log("Invalid connect wallet")}}async function ne(){await c.disconnect()}let m={can:!1,token:void 0,amount:0};function T(e,t){t=t.toUpperCase();let n=document.getElementById("btn_send_transaction");localStorage.setItem(`${t}_input_count`,"0");let a;if(!e||e<=0)n&&t!=="RUB"&&(n==null||n.classList.add("opacity-2"),n.value="Введите значение больше нуля"),a="0 BIPCoin",m.can=!1;else if(isNaN(e*1))n&&t!=="RUB"&&(n.classList.add("opacity-2"),n.value="Введено некорректное значение"),a="Некорректное значение",m.can=!1;else{a=`${ae(e,t)} BIPCoin`,localStorage.setItem(`${t}_input_count`,e);let s=localStorage.getItem(`${t}_balance`);e*1<=s?(n&&t!=="RUB"&&(n.classList.remove("opacity-2"),n.value=`Оплатить ${e*1} ${t}`),m.can=!0,m.token=t,m.amount=e):(m.can=!1,n&&t!=="RUB"&&(n.classList.add("opacity-2"),n.value="Недостаточно средств на кошельке"))}try{document.getElementById(`${t}_value`).innerHTML=a}catch{}se(e,t)}function ae(e,t){let n=localStorage.getItem("BIP_price");return t.toUpperCase()==="TON"&&(e*=localStorage.getItem("TON_price")),t.toUpperCase()==="RUB"&&(e/=localStorage.getItem("RUB_price")),Math.round(e/n*100)/100}function se(e,t){let n;e.length<=1?n="1rem":n=`${e.length*.5}rem`,document.getElementById(`${t}_input_count`).style.width=n}function le(){u("send_to_crypto"),u("send_to_card");let e=document.getElementById("send_to_crypto_content"),t;if(!(c.connected||_.wallet_connect==="true"))t=e.innerHTML,e.innerHTML=$;else{t&&(e.innerHTML=t);let s=document.getElementById("TON_input_count");s.addEventListener("input",i=>{T(i.target.value,"TON")});let l=document.getElementById("USDT_input_count");l.addEventListener("input",i=>{T(i.target.value,"USDT")}),L||(l.type="text",s.type="text")}let n=document.getElementById("send_to_card_content"),a;if(!(c.connected||_.wallet_connect==="true"))a=n.innerHTML,n.innerHTML=$;else{a&&(n.innerHTML=a);let s=document.getElementById("RUB_input_count");s.addEventListener("input",i=>{T(i.target.value,"RUB")}),L||(s.type="text");let l;try{l=window.Telegram.WebApp.initDataUnsafe.user.id}catch{l="UserID"}document.getElementById("card_send_code").innerHTML=l,document.getElementById("admin_card_number").innerHTML=v.card}}let g={can:!1,amount:0},x=0;function W(){const e=document.getElementsByClassName("wallet_please_connect"),t=document.getElementsByClassName("wallet_access_connect");if(console.log(c.connected,_.wallet_connect==="true"),c.connected||_.wallet_connect==="true"){for(let n of e)n.classList.add("hide");for(let n of t)n.classList.remove("hide");if(Number(localStorage.getItem("BIP_balance"))>0){let n=document.getElementById("BIP_input_count");n==null||n.addEventListener("input",a=>{T(a.target.value,"BIP")}),!L&&n&&(n.type="text")}}else{for(let n of e)n.classList.remove("hide");for(let n of t)n.classList.add("hide")}K([100,1e3,1e4,1]),S(),U()}function U(){var e,t,n,a,s;try{if(localStorage.getItem("BIP_balance")>0?((e=document.getElementById("BIP_input_count"))==null||e.addEventListener("input",l=>{ie(l.target.value)}),(t=document.getElementById("changer_BIP2NFT"))==null||t.classList.remove("hide")):(n=document.getElementById("changer_BIP2NFT"))==null||n.classList.add("hide"),B.length!==0){let l=document.getElementById("wallet_nft_list"),i=1,d="";B.forEach(r=>{let o=r.metadata.name;o==="BIP NFT"&&(o=r.metadata.attributes[0].value.toString()+" "+o);let b=`BIPNFT_${r.index}`;d+=`
            <div class="flex text-lg mt-2">
            <p class="mr-2 text-down">${i}.</p>
            <p class="mr-2 text-down">${o}</p>
            <input type="button" class="input_btn BIP_NFT_sale_button" id="${b}" value="Продать">
            <img src="${r.previews[1].url}" alt="${b}" class="size-8 r-0" id="${b}" >
            </div>
            `,i++}),l&&(l==null?void 0:l.innerHTML)!==d&&(l.innerHTML=d),(a=document.getElementById("changer_NFT2BIP"))==null||a.classList.remove("hide")}else(s=document.getElementById("changer_NFT2BIP"))==null||s.classList.add("hide")}catch(l){console.log(l),setTimeout(U,500)}}function S(){let e=localStorage.getItem("BIP_balance");const t=document.getElementById("BIP_balance");let n=localStorage.getItem("BIP_price");const a=document.getElementById("BIP_price");let s=localStorage.getItem("TON_balance");const l=document.getElementById("TON_balance");let i=localStorage.getItem("USDT_balance");const d=document.getElementById("USDT_balance");t&&(t.innerHTML=Math.floor(e*100)/100,l.innerHTML=Math.floor(s*100)/100,d.innerHTML=Math.floor(i*100)/100,a.innerHTML=Math.floor(n*100)/100)}function ie(e){let t=document.getElementById("btn_send_transaction_to_nft");if(localStorage.setItem("BIP_input_count","0"),!e||e<=0)t&&(t==null||t.classList.add("opacity-2"),t.value="Введите значение больше нуля"),document.getElementById("BIP_input_count").innerHTML="0 BIPCoin",g.can=!1,N();else if(isNaN(e*1))t&&(t.classList.add("opacity-2"),t.value="Некорректное значение"),document.getElementById("BIP_input_count").innerHTML="Некорректное значение",g.can=!1,N();else{document.getElementById("BIP_input_count").innerHTML=`${e} BIPCoin`,localStorage.setItem("BIP_input_count",e),N(e);let a=localStorage.getItem("BIP_balance");e*1<=a?(t&&(t.classList.remove("opacity-2"),t.value="Получить NFT"),g.can=!0,g.amount=e):(g.can=!1,t&&(t.classList.add("opacity-2"),t.value="Недостаточно средств"))}let n;e.length<=1?n="1rem":n=`${e.length*.5}rem`,document.getElementById("BIP_input_count").style.width=n}function K(e){if(typeof e=="object"){for(const t of e)K(t);return}axios.get(`https://nft.biptoken.xyz/CreateItemMetadata?value=${e}`,{responseType:"json",transformResponse:t=>t}).then(t=>{axios.get(JSON.parse(t.data).image);let n=document.getElementById("nft_preshow_img");n&&(n.src=JSON.parse(t.data).image)})}function N(e=0){let t=document.getElementById("nft_preshow_img");if(e<=0){t.classList.add("hide");return}x===e||new Array(t.classList).toString().split(" ").indexOf("hide")===-1&&(e>=1e4&&x>=1e4||e<=99&&x<=99)||(x=e,axios.get(`https://nft.biptoken.xyz/CreateItemMetadata?value=${e}`,{responseType:"json",transformResponse:a=>a}).then(a=>{let s=document.getElementById("wallet_nft_items").scrollHeight;t.style.height=`${s+we(1)-2}px`,t.src=JSON.parse(a.data).image,t.classList.remove("hide")}).catch(a=>{console.error(`Got a bad format response with status code ${a.response.status}: ${a.response.data}`)}))}let P=null;function oe(){document.addEventListener("touchstart",ce,!1),document.addEventListener("touchmove",de,!1),document.addEventListener("keydown",e=>{e.key==="ArrowRight"&&F(),e.key==="ArrowLeft"&&j()})}function ce(e){P=e.touches[0].clientX,e.touches[0].clientY}function de(e){if(!P)return;const t=e.touches[0].clientX;e.touches[0].clientY;const n=P-t;Math.abs(n)>window.screen.width/5&&(n>0?F():n<0&&j(),P=null)}const y=new window.TonWeb;async function H(e,t,n=1){const a=y.utils.Address;let s=new y.boc.Cell;return s.bits.writeUint(260734629,32),s.bits.writeUint(Date.now(),64),s.bits.writeCoins(e),s.bits.writeAddress(new a(t)),s.bits.writeAddress(new a(localStorage.getItem("wallet_address"))),s.bits.writeUint(0,1),s.bits.writeCoins(n),s.bits.writeUint(0,1),y.utils.bytesToBase64(await s.toBoc())}async function re(e,t=.15*1e9){const n=y.utils.Address;let a=new y.boc.Cell;return a.bits.writeUint(1607220500,32),a.bits.writeUint(Date.now(),64),a.bits.writeAddress(new n(e)),a.bits.writeAddress(new n(localStorage.getItem("wallet_address"))),a.bits.writeUint(0,1),a.bits.writeCoins(t),a.bits.writeUint(0,1),y.utils.bytesToBase64(await a.toBoc())}async function pe(e,t){if(e==="TON")return{validUntil:Math.floor(new Date/1e3)+360,messages:[{address:v.buy_wallet,amount:t*1e9}]};if(e==="USDT")return t*=1e6,{validUntil:Math.floor(new Date/1e3)+360,messages:[{address:localStorage.getItem("USDT_wallet_address"),amount:.06*1e9,payload:await H(t,v.buy_wallet)}]};if(e==="BIP")return t*=1e9,{validUntil:Math.floor(new Date/1e3)+360,messages:[{address:localStorage.getItem("BIP_wallet_address"),amount:.2*1e9,payload:await H(t,v.nft_wallet,.15*1e9)}]}}async function me(e){return{validUntil:Math.floor(new Date/1e3)+360,messages:[{address:e,amount:.2*1e9,payload:await re(v.nft_wallet)}]}}async function q(e="TON",t=.942){return await c.sendTransaction(await pe(e,t))}async function _e(e){return await c.sendTransaction(await me(e))}async function ue(){document.addEventListener("click",async function(e){var t,n,a,s,l,i,d,r;if((t=e.target)!=null&&t.className.includes("btn_page_wallet")&&h("wallet"),(n=e.target)!=null&&n.className.includes("btn_wallet_connect")&&await te(),(a=e.target)!=null&&a.className.includes("btn_wallet_disconnect")&&await ne(),((s=e.target)==null?void 0:s.id)==="btn_send_transaction"&&m.can&&(await q(m.token,m.amount)?document.getElementById("btn_send_transaction").value="Транзакция обрабатывается":document.getElementById("btn_send_transaction").value="Ошибка при отправке транзакции"),((l=e.target)==null?void 0:l.id)==="btn_send_transaction_to_nft"&&g.can&&(await q("BIP",g.amount)?document.getElementById("btn_send_transaction_to_nft").value="Транзакция обрабатывается":document.getElementById("btn_send_transaction_to_nft").value="Ошибка при отправке транзакции"),((i=e.target)==null?void 0:i.id)==="copy_admin_card_number"){let o=document.getElementById("admin_card_number");o.classList.add("anim"),setTimeout(()=>o.classList.remove("anim"),1e3),await navigator.clipboard.writeText(o.innerHTML)}if(((d=e.target)==null?void 0:d.id)==="copy_card_send_code"){let o=document.getElementById("card_send_code");o.classList.add("anim"),setTimeout(()=>o.classList.remove("anim"),1e3),await navigator.clipboard.writeText(o.innerHTML)}if(((r=e.target)==null?void 0:r.classList.toString().split(" ").indexOf("BIP_NFT_sale_button"))!==-1)for(const o of B)o.index.toString()===e.target.id.split("_")[1]&&(console.log(o.address),console.log(B),await _e(o.address))})}let _={},B=[],v,L;const ge="0:b113a994b5024a16719f69139328eb759596c38a25f59028b146fecdc3621dfe",fe="0:786e74bba071d57c75004bb41bf978ea73e00b03f3f3fbf2b73ea0426f97d6e9",A={BIP:fe,USDT:ge};function be(){let e=location.search.substring(1).split("&");for(let t=0;t<e.length;t++){let n=e[t].split("=");_[n[0]]=n[1]}console.log(_),_.wallet_connect}function E(){let e=localStorage.getItem("wallet_address");if(axios.get("https://api.biptoken.xyz/v1/price/tokens").then(t=>{let n=Object(t.data);Object.entries(n).forEach(a=>{localStorage.setItem(`${a[0].toUpperCase()}_price`,a[1])})}),e)axios.get(`https://tonapi.io/v2/accounts/${e}/jettons`).then(t=>{axios.get(`https://tonapi.io/v2/accounts/${localStorage.getItem("wallet_address")}/nfts?collection=EQDhO_YVxvb3p68hqte0kNG5jdO44WQFgWdCe8GvgVkrws4Z`).then(n=>{B=n.data.nft_items,U()});for(let n of t.data.balances)for(let[a,s]of Object.entries(A))n.jetton.address===s&&(localStorage.setItem(`${a}_balance`,n.balance/10**n.jetton.decimals),localStorage.setItem(`${a}_wallet_address`,n.wallet_address.address));S()}),axios.get(`https://tonapi.io/v2/accounts/${e}`).then(t=>{localStorage.setItem("TON_balance",t.data.balance/10**9)}).catch(t=>{localStorage.setItem("TON_balance",0)}).finally(()=>{S()});else{localStorage.setItem("TON_balance",0);for(let[t,n]of Object.entries(A))localStorage.setItem(`${t}_balance`,"0"),localStorage.setItem(`${t}_wallet_address`,"")}}function we(e){return e*parseFloat(getComputedStyle(document.documentElement).fontSize)}let k={};function u(e){let t=document.getElementById(`${e}_arrow`),n=document.getElementById(`${e}_content`);k[e]=0,t.addEventListener("click",()=>{k[e]?(t.innerHTML="keyboard_arrow_down",n.classList.add("hide"),k[e]=0):(t.innerHTML="keyboard_arrow_up",n.classList.remove("hide"),k[e]=1)})}async function ye(){await ue(),Z(),oe(),document.querySelectorAll(".material-symbols-outlined").forEach(n=>{n.classList.add("icon-load")}),document.fonts.ready.then(()=>{document.querySelectorAll(".material-symbols-outlined").forEach(n=>{n.classList.remove("icon-load")})});const e=document.querySelector("#root"),t=document.createElement("div");t.id="bottom-navigation",e.appendChild(t),E(),setInterval(E,1e4),await axios.get("https://api.biptoken.xyz/v1/info/payments").then(n=>{n.status===200&&(v=n.data)}),L=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}async function ve(){document.addEventListener("click",async function(e){var t,n,a,s,l,i,d,r,o,b,C,O,M;(t=e.target)!=null&&t.className.includes("link-biptoken")&&window.open("https://t.me/BIPholders","_blank"),(n=e.target)!=null&&n.className.includes("link-tg-how-to-buy")&&window.open("https://t.me/BIPholders/6","_blank"),(a=e.target)!=null&&a.className.includes("link-bipizm")&&window.open("https://t.me/BIPuserchat","_blank"),(s=e.target)!=null&&s.className.includes("link-biplions")&&window.open("https://t.me/biplions1","_blank"),(l=e.target)!=null&&l.className.includes("link-tgbot")&&window.open("https://t.me/BIPapp_bot?start=app","_blank"),(i=e.target)!=null&&i.className.includes("link-baltinvestproject")&&window.open("https://t.me/BaltInvestProekt","_blank"),(d=e.target)!=null&&d.className.includes("link-how-buy-usdt-on-wallet")&&window.open("https://telegra.ph/Kak-kupit-BIP-imeya-USDT-ili-TON-ili-lyuboj-drugoj-token-12-04","_blank"),(r=e.target)!=null&&r.className.includes("link-how-buy-usdt-on-CEX")&&window.open("https://telegra.ph/Kak-kupit-BIP-imeya-USDT-ili-TON-na-Birzhe-12-04","_blank"),(o=e.target)!=null&&o.className.includes("link-how-buy-verif-on-CEX")&&window.open("https://telegra.ph/Kak-kupit-BIP-imeya-verifikaciyu-na-Birzhe-12-04","_blank"),(b=e.target)!=null&&b.className.includes("link-how-buy-rub")&&window.open("https://telegra.ph/Kak-kupit-BIP-imeya-RUB-12-04","_blank"),(C=e.target)!=null&&C.className.includes("link-how-sell-rub")&&window.open("https://telegra.ph/Kak-prodat-BIPCoin-02-08","_blank"),(O=e.target)!=null&&O.className.includes("link-how-create-tk")&&window.open("https://telegra.ph/Kak-sozdat-svoj-koshelek-Tonkeeper-12-16","_blank"),(M=e.target)!=null&&M.className.includes("link-baltinvestpro-stats")&&window.open("https://www.rusprofile.ru/id/4405609","_blank")})}function z(){u("faq"),u("faq_get_bip"),u("faq_why_we_work"),u("faq_how_bip_work"),u("faq_how_much_pay"),u("faq_details"),document.getElementById("faq_arrow").addEventListener("click",()=>{document.getElementById("faq").classList.toggle("inline")})}const I=document.querySelector("#page");function V(e=0){p==="info"?(I.innerHTML=D,z()):p==="wallet"?(I.innerHTML=X,W()):p==="cart"?(I.innerHTML=Y,le()):p==="book"?I.innerHTML=G:p==="error_tg"&&(I.innerHTML=D+J,z())}async function he(){be(),await ve(),ee()||(await ye(),Q(),V())}document.addEventListener("DOMContentLoaded",async()=>he());
